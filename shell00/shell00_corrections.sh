...
#    Updated: 2023/07/10 02:14:18 by jdetre           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
#!/bin/bash
...
echo $result
ls -l
if [ "${result}" = "${liste}" ] && [ $(ls -l | grep -e test8 -e test9 | wc -l) -eq 0 ] && [ $(ls -l | grep test10 | wc -l) -eq 1 ] && [ $(ls -l test10/*| grep -e test8 -e test9 ) -eq 0 ]; then
	echo "Ex05/git_commit : $vert$tcheck$resetcolor\n"
else
	echo "Ex05/git_commit : $rouge$croix$resetcolor\n"
fi
